...
def settings(event):
    ...
    NSSettingsProfile = tkmacosx.Button(NSSettingsView, text='   {}'.format(getpass.getuser()), borderless=1, font=("Futura", 20), height=80, width=400, activebackground='white', activeforeground='black', image=NSSettingsProfilepic, compound=LEFT)
...
def shutdown():
    rumps.notification(title='Project-Pios', subtitle='关机', message='您将Project-Pios关掉了')
    NSCanvas.destroy()
    root.destroy()
    sys.exit(0)
